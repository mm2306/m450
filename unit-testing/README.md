...
### Quellcode-Dateien:
* Hauptklasse: [src/main/java/ch/tbz/Calculator.java](src/main/java/ch/tbz/Calculator.java)
* Testklasse: [src/test/java/ch/tbz/CalculatorTest.java](src/test/java/ch/tbz/CalculatorTest.java)
...
Die Banken-Simulation basiert auf einem objektorientierten Modell zur Verwaltung von Bankkonten und Buchungen:s

Account als *abstract class* für SavingsAccount, Salary und PromoYouthSavingsAccount

### Funktionsweise & Zusammenhänge der Klassen:
* **`Account`**: Parent-Klasse für alle Kontoverwaltungen. Speichert die Kontonummer, den Kontostand (`balance`) und eine Liste aller `Booking`-Objekte. Bietet Methoden für `deposit` (Einzahlen) und `withdraw` (Abheben).
...
* [AccountTests.java](02_bank-vorgabe/src/test/java/ch/schule/bank/junit5/AccountTests.java): Testet Einzahlungen, Abhebungen und Kontostandsabfragen der Basisklasse.
* [SavingsAccountTests.java](02_bank-vorgabe/src/test/java/ch/schule/bank/junit5/SavingsAccountTests.java): Testet Sparzinsen und Abbuchungslimiten.
* [SalaryAccountTests.java](02_bank-vorgabe/src/test/java/ch/schule/bank/junit5/SalaryAccountTests.java): Testet Überziehungslimit-Berechnungen.
* [PromoYouthSavingsAccountTests.java](02_bank-vorgabe/src/test/java/ch/schule/bank/junit5/PromoYouthSavingsAccountTests.java): Testet Bonuszinsen.
* [BankTests.java](02_bank-vorgabe/src/test/java/ch/schule/bank/junit5/BankTests.java) / [TestBank.java](02_bank-vorgabe/src/test/java/ch/schule/bank/junit5/TestBank.java): Testet Kontoanmeldungen, Überweisungen und Suchfunktionen.
* [BookingTests.java](02_bank-vorgabe/src/test/java/ch/schule/bank/junit5/BookingTests.java): Testet Transaktionsprotokollierung.
